...
public class NopModelPart {
    ...
    public final ObjectList<ModelBox> cubes = new ObjectArrayList();
    ...
    public NopModelPart addBox(String p_217178_1_, float p_217178_2_, float p_217178_3_, float p_217178_4_, int p_217178_5_, int p_217178_6_, int p_217178_7_, float p_217178_8_, int p_217178_9_, int p_217178_10_) {
        ...
        this.addBox(this.xTexOffs, this.yTexOffs, p_217178_2_, p_217178_3_, p_217178_4_, p_217178_5_, p_217178_6_, p_217178_7_, p_217178_8_, p_217178_8_, p_217178_8_, this.mirror, false);
        return this;
    }
    ...
    private void addBox(int p_228305_1_, int p_228305_2_, float p_228305_3_, float p_228305_4_, float p_228305_5_, float p_228305_6_, float p_228305_7_, float p_228305_8_, float p_228305_9_, float p_228305_10_, float p_228305_11_, boolean p_228305_12_, boolean p_228305_13_) {
        this.cubes.add(new ModelBox(p_228305_1_, p_228305_2_, p_228305_3_, p_228305_4_, p_228305_5_, p_228305_6_, p_228305_7_, p_228305_8_, p_228305_9_, p_228305_10_, p_228305_11_, p_228305_12_, this.xTexSize, this.yTexSize));
    }
    ...
    private void compile(PoseStack.Pose p_228306_1_, VertexConsumer p_228306_2_, int p_228306_3_, int p_228306_4_, float p_228306_5_, float p_228306_6_, float p_228306_7_, float p_228306_8_) {
        ...
        for (ModelBox MpmModelPart$modelbox : this.cubes) {
            for (TexturedQuad MpmModelPart$texturedquad : MpmModelPart$modelbox.polygons) {
                Vector3f vector3f = matrix3f.transform(new Vector3f((Vector3fc)MpmModelPart$texturedquad.normal));
                float f = vector3f.x();
                float f1 = vector3f.y();
                float f2 = vector3f.z();
                for (int i = 0; i < 4; ++i) {
                    PositionTextureVertex MpmModelPart$positiontexturevertex = MpmModelPart$texturedquad.vertices[i];
                    ...
                    p_228306_2_.addVertex(vector4f.x(), vector4f.y(), vector4f.z(), ((int)(p_228306_8_ * 255) << 24) | ((int)(p_228306_5_ * 255) << 16) | ((int)(p_228306_6_ * 255) << 8) | (int)(p_228306_7_ * 255), MpmModelPart$positiontexturevertex.u, MpmModelPart$positiontexturevertex.v, p_228306_4_, p_228306_3_, f, f1, f2);
                }
            }
        }
    }
    ...
    public NopModelPart setTexSize(int p_78787_1_, int p_78787_2_) {
        this.xTexSize = p_78787_1_;
        this.yTexSize = p_78787_2_;
        return this;
    }

    public ModelBox getRandomCube(Random p_228310_1_) {
        return (ModelBox)this.cubes.get(p_228310_1_.nextInt(this.cubes.size()));
    }

    @OnlyIn(value=Dist.CLIENT)
    public static class ModelBox {
        public TexturedQuad[] polygons;
        public float minX;
        public float minY;
        public float minZ;
        public float maxX;
        ...
        public ModelBox(int p_i225950_1_, int p_i225950_2_, float p_i225950_3_, float p_i225950_4_, float p_i225950_5_, float p_i225950_6_, float p_i225950_7_, float p_i225950_8_, float p_i225950_9_, float p_i225950_10_, float p_i225950_11_, boolean p_i225950_12_, float p_i225950_13_, float p_i225950_14_) {
            ...
            PositionTextureVertex MpmModelPart$positiontexturevertex7 = new PositionTextureVertex(p_i225950_3_, p_i225950_4_, p_i225950_5_, 0.0f, 0.0f);
            PositionTextureVertex MpmModelPart$positiontexturevertex = new PositionTextureVertex(f, p_i225950_4_, p_i225950_5_, 0.0f, 8.0f);
            PositionTextureVertex MpmModelPart$positiontexturevertex1 = new PositionTextureVertex(f, f1, p_i225950_5_, 8.0f, 8.0f);
            PositionTextureVertex MpmModelPart$positiontexturevertex2 = new PositionTextureVertex(p_i225950_3_, f1, p_i225950_5_, 8.0f, 0.0f);
            PositionTextureVertex MpmModelPart$positiontexturevertex3 = new PositionTextureVertex(p_i225950_3_, p_i225950_4_, f2, 0.0f, 0.0f);
            PositionTextureVertex MpmModelPart$positiontexturevertex4 = new PositionTextureVertex(f, p_i225950_4_, f2, 0.0f, 8.0f);
            PositionTextureVertex MpmModelPart$positiontexturevertex5 = new PositionTextureVertex(f, f1, f2, 8.0f, 8.0f);
            PositionTextureVertex MpmModelPart$positiontexturevertex6 = new PositionTextureVertex(p_i225950_3_, f1, f2, 8.0f, 0.0f);
            float f4 = p_i225950_1_;
            ...
            float f10 = p_i225950_2_;
            float f11 = (float)p_i225950_2_ + p_i225950_8_;
            float f12 = (float)p_i225950_2_ + p_i225950_8_ + p_i225950_7_;
            this.polygons[2] = new TexturedQuad(new PositionTextureVertex[]{MpmModelPart$positiontexturevertex4, MpmModelPart$positiontexturevertex3, MpmModelPart$positiontexturevertex7, MpmModelPart$positiontexturevertex}, f5, f10, f6, f11, p_i225950_13_, p_i225950_14_, p_i225950_12_, Direction.DOWN);
            this.polygons[3] = new TexturedQuad(new PositionTextureVertex[]{MpmModelPart$positiontexturevertex1, MpmModelPart$positiontexturevertex2, MpmModelPart$positiontexturevertex6, MpmModelPart$positiontexturevertex5}, f6, f11, f7, f10, p_i225950_13_, p_i225950_14_, p_i225950_12_, Direction.UP);
            this.polygons[1] = new TexturedQuad(new PositionTextureVertex[]{MpmModelPart$positiontexturevertex7, MpmModelPart$positiontexturevertex3, MpmModelPart$positiontexturevertex6, MpmModelPart$positiontexturevertex2}, f4, f11, f5, f12, p_i225950_13_, p_i225950_14_, p_i225950_12_, Direction.WEST);
            this.polygons[4] = new TexturedQuad(new PositionTextureVertex[]{MpmModelPart$positiontexturevertex, MpmModelPart$positiontexturevertex7, MpmModelPart$positiontexturevertex2, MpmModelPart$positiontexturevertex1}, f5, f11, f6, f12, p_i225950_13_, p_i225950_14_, p_i225950_12_, Direction.NORTH);
            this.polygons[0] = new TexturedQuad(new PositionTextureVertex[]{MpmModelPart$positiontexturevertex4, MpmModelPart$positiontexturevertex, MpmModelPart$positiontexturevertex1, MpmModelPart$positiontexturevertex5}, f6, f11, f8, f12, p_i225950_13_, p_i225950_14_, p_i225950_12_, Direction.EAST);
            this.polygons[5] = new TexturedQuad(new PositionTextureVertex[]{MpmModelPart$positiontexturevertex3, MpmModelPart$positiontexturevertex4, MpmModelPart$positiontexturevertex5, MpmModelPart$positiontexturevertex6}, f8, f11, f9, f12, p_i225950_13_, p_i225950_14_, p_i225950_12_, Direction.SOUTH);
        }
    }
    ...
    public static class TexturedQuad {
        ...
        public TexturedQuad(PositionTextureVertex[] p_i225951_1_, float p_i225951_2_, float p_i225951_3_, float p_i225951_4_, float p_i225951_5_, float p_i225951_6_, float p_i225951_7_, boolean p_i225951_8_, Direction p_i225951_9_) {
            ...
            if (p_i225951_8_) {
                ...
                for (int j = 0; j < i / 2; ++j) {
                    PositionTextureVertex MpmModelPart$positiontexturevertex = p_i225951_1_[j];
